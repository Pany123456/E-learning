...
use App\Http\Controllers\CoursesControllers;
use App\Http\Controllers\FomateurController;
...
Route::get('/cours', [CoursesControllers::class,'index'])->name('cours.index');

Route::get('/formateur', [FomateurController::class,'index'])->name('formateur.index');
