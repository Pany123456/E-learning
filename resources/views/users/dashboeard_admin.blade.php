    ...
    <div class="card-body px-xxl-0 pt-4">
      <div class="row g-0">
        <div class="col-xxl-3 col-md-6 px-3 text-center border-end-md border-bottom border-bottom-xxl-0 pb-3 p-xxl-0 ps-md-0">
          ...
          <h4 class="mb-1 font-sans-serif"><span class="text-700 mx-2" data-countup='{"endValue":"{{$nbr_users[1]}}"}'>0</span><span class="fw-normal text-600">New Learners</span></h4>
          <p class="fs--1 fw-semi-bold mb-0">{{$nbr_users[0]}} <span class="text-600 fw-normal">last month</span></p>
        </div>
  ...
  new Chart(ctx, {
      ...
      options: {
          ...
          animation: {
              ...
              // easing: 'linear' // Adjust the easing function for the animation
              tension: {
              duration: 1000,
              easing: 'linear',
              from: 1,
